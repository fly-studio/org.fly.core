...
public final class FunctionUtils {
    ...
    /**
     * Create an other program's interface
     * And use a same struct instance instead of the interface
     * under IPC or Xposed
     *
     *
     * @param otherSameInstance
     * @param classLoader
     * @param interfaces
     * @return
     */
    public static Object newInterface(final Object otherSameInstance, ClassLoader classLoader, Class... interfaces) {
        return java.lang.reflect.Proxy.newProxyInstance(
                ...
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) {
                        ...
                        //System.out.print("Call interface: "+method_name+"(" + (classes.toString()) + ")");

                        return callMethod(otherSameInstance, method_name, args == null ? new Object[]{} : args);
                    }
                }
        );
    }
    ...
    /**
     * https://github.com/apache/commons-lang/blob/LANG_3_4/src/main/java/org/apache/commons/lang3/reflect/MemberUtils.java
     */
